...
class PointSensor:
    def __init__(self,
        ...
        # ✅ Fix for missing '2015-06-01T00:00:00' timestamp
        if time_array[0] == 1433116860:
            time_array = np.insert(time_array, 0, 1433116800)
    ...
    def change_time_base(self, new_time_base: int) -> 'PointSensor':
        ...
        end_time = (self.time_array[-1]) if self.time_array[-1] % new_time_base == 0 else self.time_array[-1] - \
                                                                                          self.time_array[
                                                                                              -1] % new_time_base
        #end_time -= new_time_base # Remove if you want to preserve the last full window during downsampling
